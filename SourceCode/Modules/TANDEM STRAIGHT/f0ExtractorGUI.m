...
% Last Modified by GUIDE v2.5 07-Nov-2009 16:55:17
...
if isfield(STRAIGHTobject,'refinedF0Structure')
    STRAIGHTobject.f0Structure = STRAIGHTobject.refinedF0Structure;
    STRAIGHTobject.f0 = STRAIGHTobject.refinedF0Structure.f0;
    STRAIGHTobject.temporalPositions = STRAIGHTobject.refinedF0Structure.temporalPositions;
    if isfield(STRAIGHTobject.refinedF0Structure,'periodicityLevel')
        STRAIGHTobject.periodicityLevel = STRAIGHTobject.refinedF0Structure.periodicityLevel;
    end
    if isfield(STRAIGHTobject.refinedF0Structure,'f0CandidatesMap')
        STRAIGHTobject.f0CandidatesMap = STRAIGHTobject.refinedF0Structure.f0CandidatesMap;
    end
    if isfield(STRAIGHTobject.refinedF0Structure,'f0CandidatesScoreMap')
        STRAIGHTobject.f0CandidatesScoreMap = STRAIGHTobject.refinedF0Structure.f0CandidatesScoreMap;
    end
    if isfield(STRAIGHTobject.refinedF0Structure,'f0candidatesPowerMap')
        STRAIGHTobject.f0candidatesPowerMap = STRAIGHTobject.refinedF0Structure.f0candidatesPowerMap;
