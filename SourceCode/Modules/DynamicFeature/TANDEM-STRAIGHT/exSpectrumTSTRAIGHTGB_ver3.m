function spectrumParamter = exSpectrumTSTRAIGHTGB_ver3(x,fs,sourceObj,paramsIn)
...
spectrumParamter.framePeriod =   1; % in ms •ÏX
% spectrumParamter.framePeriod = 5; % in ms
%f0lowLimit = 70;
...
if nargin > 2
    temporalPositions = 0:spectrumParamter.framePeriod/1000:length(x)/fs;
