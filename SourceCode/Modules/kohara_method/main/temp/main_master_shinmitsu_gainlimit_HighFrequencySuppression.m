...
%                         outputDirName = ['../voice_data/shinmitsu_test_gainlimit/shinmitsu_' speaker_name{s_n} '/kneeWidth_dB_' num2str(kneeWidth_dB, '%02d') 'dB/' num2str(maxfreq(v)) 'Hz/' num2str(setGain(setGain_num)) 'dB/' ];
%                         outputDirName = ['../voice_data/shinmitsu_test_gainlimit/shinmitsu_' speaker_name{s_n} '/kneeWidth_dB_' num2str(kneeWidth_dB, '%02d') 'dB/' num2str(maxfreq(v)) 'Hz/' num2str(setGain(setGain_num)) 'dB/' ];
                        ...
                        if threshold_dB(threshold_dB_num) ~= 0,
                            ...
                            outputName = [inputName '_' num2str(setGain(setGain_num)) 'dB_' num2str(T(t)) 'band_hanning' num2str(maxfreq(v)) 'Hz_Gainlimit' num2str(threshold_dB(threshold_dB_num)) 'dB_HighSup' num2str(highfreq) 'Hz'];
                        else
        ...
        outputDirName_orinorm = ['../voice_data/shinmitsu_test_gainlimit/shinmitsu_' speaker_name{s_n} '/original_normalization/' ];
        mkdir(outputDirName_orinorm);
        audiowrite([outputDirName_orinorm inputName '_normalization.wav'],X_norm, fs, 'BitsPerSample',24)
    end
end
disp('Completion');