...
%% make WORLD spectrogram mat file related to each mask condition with 4 mora word list
...
for mask_index = 1 : length(mask_list)
    for file_index = 1 : 50
        ...
        CheapTrick_option.fft_size = (2 ^ 13);
        ...
        save(mat_file_path, "signal", "sample_rate", "source_information", "aperiodicity_structure", "spectrum_parameters", "label", "audio_file_manipulator", "Harvest_option", "CheapTrick_option", "label_file_path", "audio_file_path");
    end
end