...
sy=straightSynthTB07ca(n3sgram,f0raw,shiftm,fs, ...
    pconv,fconv,sconv,gdbw,delfrac,delsp,cornf,delfracind,ap,imap); % 8/April/2002
if normalizedOut
...
if isfield(prmin,'cornf')==1;
    prm.groupDelayRandomizeCornerFrequency=prmin.cornf;end;
if isfield(prmin,'ratioToFundamentalPeriod')==1;
    prm.ratioToFundamentalPeriod=prmin.ratioToFundamentalPeriod;end;
if isfield(prmin,'delfrac')==1;
    prm.ratioToFundamentalPeriod=prmin.delfrac;end;
if isfield(prmin,'ratioModeIndicator')==1;
    prm.ratioModeIndicator=prmin.ratioModeIndicator;end;
if isfield(prmin,'delfracind')==1;
    prm.ratioModeIndicator=prmin.delfracind;end;
...
if isfield(prmin,'pconv')==1;
    prm.fundamentalFrequencyMappingTable=prmin.pconv;end;
if isfield(prmin,'fconv')==1;
    prm.frequencyAxisMappingTable=prmin.fconv;end;
if isfield(prmin,'sconv')==1;
    prm.timeAxisStretchingFactor=prmin.sconv;end;
return;
