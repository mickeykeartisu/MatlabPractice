function sy=straightSynthTB06g(n2sgram,f0raw,f0var,f0varL,shiftm,fs, ...
...
%   sy=straightSynthTB06g(n2sgram,f0raw,f0var,f0varL,shiftm,fs, ...
...
%	bv	: aperiodicity boundary parameter
...
%    ccp=real(fft(log(ff+0.001))); % 23rd July, 1999
	ccp=real(fft(log(ff+dmx/10000))); % 23rd July, 1999
    ccp2=[ccp(1);2*ccp(2:fftl/2);0*ccp(fftl/2+1:fftl)];
    ffx=(fft(ccp2.*lft)/fftl);
    nf0=fs/f0;
