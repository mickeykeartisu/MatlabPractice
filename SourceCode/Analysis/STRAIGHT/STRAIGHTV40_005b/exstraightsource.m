...
if nargin > 2 & isfield(optionalParams,'NewVersion') == 1 ...
  & optionalParams.NewVersion == 1
  disp(['Using new version for F0 extraction...']);
  [f0,vuv,auxouts,analysisParams]=MulticueF0v14(x,fs,optionalParams);
  [ap,analysisParamsAP]=exstraightAPind(x,fs,f0,optionalParams);
